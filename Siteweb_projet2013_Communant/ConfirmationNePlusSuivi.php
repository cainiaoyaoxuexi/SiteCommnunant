<?php
//Page de confirmation après "choix de ne plus suivre un membre" dans profil.php
...
$requeteNPS = "DELETE FROM ABONNER WHERE IDM='$IDM' AND IDM_ABONNER='$IDMprofil'";
$resultatNPS = mysql_query($requeteNPS);
$msg=mysql_error();
echo("$msg");
?>
...
echo ("<h1> &nbsp </h1><h3>Vous ne suivez plus ".$nuplet["PRENOM"]." ".$nuplet["NOMM"]." "."(alias"." ".$nuplet["PSEUDO"].") </h3>"); ?>
