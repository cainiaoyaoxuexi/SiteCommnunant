 <?php
//Page de confirmation après "suppression dune compétence" dans ModifProfil.php
require("moduleFonction.php");
connexionChoixBase();
session_start();
$IDM = $_SESSION["IDM"];
$comp= $_GET["IDCompàSupprimmer"];
...
<div class="style"> 
  ...
  <div class="contenu"> <br>
    <h3>Vous avez bien supprimé cette compétence de votre profil !</h3>
